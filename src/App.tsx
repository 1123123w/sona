...
export function App() {
  ...
  const sidebarItems = useMemo(() => {
    ...
    const debugSidebarItem: SidebarItem = { id: 'debug', icon: <BugIcon />, label: t('nav.debug') }
    const updateSidebarItem: SidebarItem = { id: 'update', icon: <ZapIcon />, label: t('nav.update') }
